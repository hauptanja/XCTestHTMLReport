#!/bin/bash
## ORIGINAL INSTALL SCRIPT - not applicable here 
...
CURL=$(curl -L -s -w "%{http_code}" -o $OUT_ZIP https://github.com/hauptanja/XCTestHTMLReport/releases/download/$VERSION/xchtmlreport-$VERSION.zip)
